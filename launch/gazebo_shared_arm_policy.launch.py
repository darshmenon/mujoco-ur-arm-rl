...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                "model_path",
                default_value="/home/asimov/mujoco-ur-arm-rl/models/shared_arm/shared_arm_8arm_all_samples_gpu_20260410_1441/best_model.zip",
            ),
            DeclareLaunchArgument("joint_state_topic", default_value="/joint_states"),
            DeclareLaunchArgument("arm_trajectory_topic", default_value="/arm_controller/joint_trajectory"),
